...
require_once(__DIR__."/../modelo/modeloMetodoPedidos.php");
    ...
    $pedidoCancelado = new modeloPedidos();
    //Redirecciono a la vista cancelarPedido.php
    require_once(__DIR__."/../vista/cancelarPedido.php");
    //Hago una lógica que si encuentra ($_POST['borrar'])
